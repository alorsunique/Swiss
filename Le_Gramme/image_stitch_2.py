...
print(type(mod_time_list[0]))

print(sorted(mod_time_list))
...
creation_time = time.mktime(sorted(mod_time_list)[0])
modification_time = time.mktime(sorted(mod_time_list)[0])
...
mod_time_string = time.strftime("%Y%m%d_%H%M%S",sorted(mod_time_list)[0])
